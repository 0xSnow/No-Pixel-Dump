...
DOOR_CONFIG = {
  ...
  {
    info = "kikis clothing left door",
    active = true,
    id = getDoorId(),
    coords = vector3(92.37,-1414.87,29.57),
    model = 868499217,
    lock = true,
    desc = "",
    access = {
  ...
  {
    info = "kikis clothing right door",
    active = true,
    id = getDoorId(),
    connected = getLatestDoorId() - 1,
    coords = vector3(90.62,-1413.41,29.57),
    model = -1148826190,
    lock = true,
    desc = "",
    access = {
