...
RegisterUICallback('np-ottosauto:business:sale:accepted', function(data, cb)
  ...
  local success, errMessage = NPX.Procedures.execute("np-ottosauto:vehicle:accepted", workerId, customerId, businessAccountId, price, ("Otto's Auto: %s handled by [%s] %s %s"):format(vehiclePlate, workerId, sellerFirstName, sellerLastName), transactionType, vin, vehicleEntityHandle, workerServerId)
