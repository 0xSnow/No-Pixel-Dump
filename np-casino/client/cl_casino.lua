...
local carOnShow = `gt86`
local carOnShowAppearence = json.decode('{"colors":{"primary":111,"secondary":29,"pearlescent":0,"wheels":0,"tyre":{"r":255,"g":255,"b":255},"neon":{"r":255,"g":255,"b":255},"xenon":8,"dashboard":0,"interior":0},"tint":-1,"neon":{"left":false,"right":false,"front":false,"back":false},"extras":[],"wheelType":0,"oldLivery":0,"plateIndex":0}')
local carOnShowMods = json.decode('{"Spoilers":0,"FrontBumper":4,"RearBumper":2,"SideSkirt":2,"Exhaust":-1,"Frame":1,"Grille":-1,"Hood":0,"Fender":-1,"RightFender":-1,"Roof":-1,"Engine":4,"Brakes":2,"Transmission":3,"Horns":-1,"Suspension":3,"Armor":-1,"UNK17":0,"Turbo":1,"UNK19":0,"TireSmoke":0,"UNK21":0,"XenonHeadlights":1,"FrontWheels":96,"BackWheels":-1,"PlateHolder":-1,"VanityPlates":-1,"InteriorTrim":-1,"Ornaments":-1,"Dashboard":-1,"Dials":-1,"DoorSpeakers":-1,"Seats":-1,"SteeringWheel":-1,"ShiftLeavers":-1,"Plaques":-1,"Speakers":-1,"Trunk":-1,"Hydraulics":-1,"EngineBlock":-1,"AirFilter":-1,"Struts":-1,"ArchCover":-1,"Aerials":-1,"ExteriorTrim":-1,"Tank":-1,"Windows":-1,"UNK47":-1,"Livery":-1}')
...
local wheelDui = nil
local tvDui = nil
local tvUri = "https://i.imgur.com/DuXhmQO.jpg" -- "https://prod-gta.nopixel.net/dui/?type=video&src=https://i.imgur.com/bgn4RKc.mp4&encoding=mp4"
local wheelUrl = nil
