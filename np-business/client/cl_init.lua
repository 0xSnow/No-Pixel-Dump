Citizen.CreateThread(function()
  -- tavern
  exports["np-polyzone"]:AddBoxZone("business_stash", vector3(1225.36, -421.77, 67.77), 1.2, 1.2, {
    heading = 345,
    minZ = 66.77,
    maxZ = 68.97,
    data = {
  ...
  -- tavern
  exports["np-polyzone"]:AddBoxZone("business_stash", vector3(1233.37, -417.58, 67.77), 1, 1, {
    heading = 0,
    minZ = 66.77,
    maxZ = 68.97,
    data = {
  ...
  exports["np-polyzone"]:AddBoxZone("business_stash", vector3(848.95, -2880.61, 11.45), 2, 2, {
    heading=0,
    --debugPoly=true,
    minZ=10.3,
    maxZ=12.9,
