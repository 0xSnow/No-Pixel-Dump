...
function HealEMS()
	Citizen.CreateThread(function()
	  ...
	  while healtime > 0 do
		  Citizen.Wait(1000)
		  healtime = healtime - 1
		  exports['ragdoll']:SetPlayerHealth(GetEntityHealth(PlayerPedId()) + 10)
	  end
...
function HealSlow(time, healamount)
  Citizen.CreateThread(function()
    ...
    while healtime > 0 do
        Citizen.Wait(1000)
        healtime = healtime - 1
        exports['ragdoll']:SetPlayerHealth(GetEntityHealth(PlayerPedId()) + (healamount and healamount or 1))
    end
